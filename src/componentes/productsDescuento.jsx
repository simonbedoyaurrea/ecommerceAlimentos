...
export default function ProductsDescuento({bolsa,setBolsa,producto,totalPagar,setTotalPagar}) {
  const colores = {
    Frutas: 'rgb(204, 103, 103)',
  ...
  const addProducto = (producto) => {
    ...
    setTotalPagar((totalPagar+(producto.quantity*producto.precio)))
  };

  return (
    <>
      <div className='contenedor-producto'>
        <div className='imagen-producto-descuentos' style={{ backgroundColor: colorFondo }}>FOOD</div>
