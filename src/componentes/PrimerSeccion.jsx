...
export default function PrimerSeccion() {
  return (
    <div className='primer-seccion'> 
      <div className='text-container-ps'>
      ...
      <img className='imagen-ps' src="https://png.pngtree.com/png-clipart/20231116/original/pngtree-fruits-and-vegetables-market-photo-png-image_13575958.png" alt="" />
    </div>
  )
}
